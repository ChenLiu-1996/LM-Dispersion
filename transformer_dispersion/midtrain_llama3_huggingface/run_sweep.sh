...
declare -a CONFIGS=(
    "none:None:llama3-baseline:1"
    "infonce_l2:infonce_l2:llama3-infonce-l2-all-0.5:2"
    "infonce_cosine:infonce_cosine:llama3-infonce-cosine-all-0.5:3"
    "hinge:hinge:llama3-hinge-all-0.5:4"
    "covariance:covariance:llama3-covariance-all-0.5:5"
)
