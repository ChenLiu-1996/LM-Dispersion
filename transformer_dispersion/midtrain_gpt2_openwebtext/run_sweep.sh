...
BASE_CMD="accelerate launch --mixed_precision bf16 midtrain.py --model_name gpt2 --dataset_name Skylion007/openwebtext --train_tokens 1_600_000_000 --lr 1e-5 --block_size 1024 --per_device_train_batch_size 4 --gradient_accumulation_steps 32 --use_wandb --wandb_project gpt2-midtrain-dispersion-openwebtext-1e-6 --num_workers 16"
